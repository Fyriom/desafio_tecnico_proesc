...
{    
   ...
   {
    $produtos = \App\Models\Product::all();
    $categories = \App\Models\Category::all(); # Atribuição da coleção
    return view('produtos', ['categories' => $categories, 'produtos' => $produtos] ); # Encaminhando a coleção $categories como parâmetro para view
   }
